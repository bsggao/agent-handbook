---
title: "02 · 02-dotnet-agent-framework"
outline: [2, 3]
---

# 02 · 02-dotnet-agent-framework

[返回：探索 Agent 框架](/lessons/frameworks.md) · [不可变原始文件](https://github.com/microsoft/ai-agents-for-beginners/blob/25b7985f3b2dc37a84f4a7387ccd3c9f0e5b1595/02-explore-agentic-frameworks/code_samples/02-dotnet-agent-framework.md)
...
完整代码请参见 [`02-dotnet-agent-framework.cs`](/labs/02-explore-agentic-frameworks-code-samples-02-dotnet-agent-framework-csharp.md)。
