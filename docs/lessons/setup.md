---
title: "环境配置与学习准备"
description: "准备 Python、运行环境与第一个实验。"
course: "setup"
prev: {"text": "学习路线", "link": "/guide/roadmap"}
next: {"text": "AI Agent 入门与应用场景", "link": "/lessons/introduction"}
---
...
- [AzureSearch.cs](/labs/00-course-setup-azuresearch-csharp.md)
- [AzureSearch.md](/labs/00-course-setup-azuresearch-notes.md)

## 本章来源

基于 [英文原文](https://github.com/microsoft/ai-agents-for-beginners/blob/25b7985f3b2dc37a84f4a7387ccd3c9f0e5b1595/00-course-setup/README.md) 与 [简体中文翻译](https://github.com/microsoft/ai-agents-for-beginners/blob/25b7985f3b2dc37a84f4a7387ccd3c9f0e5b1595/translations/zh-CN/00-course-setup/README.md) 整理，原作者为 Microsoft 与开源贡献者，采用 MIT 许可证。本页标明“补充讲解”与“扩展实践”的内容为本项目新增。
