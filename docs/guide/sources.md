...
- 原仓库：[microsoft/ai-agents-for-beginners](https://github.com/microsoft/ai-agents-for-beginners)。
- 提交：[`25b7985f3b2dc37a84f4a7387ccd3c9f0e5b1595`](https://github.com/microsoft/ai-agents-for-beginners/tree/25b7985f3b2dc37a84f4a7387ccd3c9f0e5b1595)。
- 提交时间：`2026-09-10T00:35:03+01:00`。
- 获取日期： **2026-09-14** 。
...
| --- | --- | --- | --- | --- |
| 00 | `00-course-setup` | [环境配置与学习准备](/lessons/setup.md) | 1 | 正文、导读与练习已实现 |
| 01 | `01-intro-to-ai-agents` | [AI Agent 入门与应用场景](/lessons/introduction.md) | 2 | 正文、导读与练习已实现 |
| 02 | `02-explore-agentic-frameworks` | [探索 Agent 框架](/lessons/frameworks.md) | 3 | 正文、导读与练习已实现 |
| 03 | `03-agentic-design-patterns` | [Agent 设计模式](/lessons/design-patterns.md) | 2 | 正文、导读与练习已实现 |
| 04 | `04-tool-use` | [工具调用](/lessons/tools.md) | 3 | 正文、导读与练习已实现 |
| 05 | `05-agentic-rag` | [Agentic RAG](/lessons/rag.md) | 3 | 正文、导读与练习已实现 |
| 06 | `06-building-trustworthy-agents` | [构建可信赖的 Agent](/lessons/trust.md) | 2 | 正文、导读与练习已实现 |
| 07 | `07-planning-design` | [规划模式](/lessons/planning.md) | 2 | 正文、导读与练习已实现 |
| 08 | `08-multi-agent` | [多 Agent 协作](/lessons/multi-agent.md) | 14 | 正文、导读与练习已实现 |
| 09 | `09-metacognition` | [元认知与反思](/lessons/reflection.md) | 1 | 正文、导读与练习已实现 |
| 10 | `10-ai-agents-production` | [Agent 生产实践](/lessons/production.md) | 2 | 正文、导读与练习已实现 |
| 11 | `11-agentic-protocols` | [Agent 协议：MCP、A2A、NLWeb](/lessons/protocols.md) | 11 | 正文、导读与练习已实现 |
| 12 | `12-context-engineering` | [上下文工程](/lessons/context.md) | 1 | 正文、导读与练习已实现 |
| 13 | `13-agent-memory` | [Agent 记忆](/lessons/memory.md) | 2 | 正文、导读与练习已实现 |
| 14 | `14-microsoft-agent-framework` | [Microsoft Agent Framework](/lessons/agent-framework.md) | 8 | 正文、导读与练习已实现 |
| 15 | `15-browser-use` | [Computer Use 与 Browser Use](/lessons/browser-use.md) | 1 | 正文、导读与练习已实现 |
| 16 | `16-deploying-scalable-agents` | [可扩展部署](/lessons/deployment.md) | 1 | 正文、导读与练习已实现 |
| 17 | `17-creating-local-ai-agents` | [本地 Agent](/lessons/local-agents.md) | 1 | 正文、导读与练习已实现 |
| 18 | `18-securing-ai-agents` | [Agent 安全](/lessons/security.md) | 3 | 正文、导读与练习已实现 |
...
本地获取 **98** 张源图片（包括用于来源核对的英文/中文和横幅资源），仅在相关正文展示必要配图；另绘制 8 幅中文 SVG，涵盖循环、时序、RAG、规划、协作、上下文、MCP 与部署。来源图以 Microsoft/MIT 标注，本项目重绘图明确标注。
